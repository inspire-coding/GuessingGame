package com.inspirecoding.guessinggame.viewmodel
...
import com.inspirecoding.guessinggame.utils.GuessResult
...
class GameViewModel : ViewModel()
{
    ...
    fun play(context: Context, guessTextView: TextInputEditText, gameIsRunning: Boolean)
    {
        if (gameIsRunning)
        {
